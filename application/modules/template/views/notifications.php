<ul class="nav navbar-nav pull-right">
    ...
    <li class="dropdown dropdown-user">
        ...
        <ul class="dropdown-menu dropdown-menu-default">
            ...
            <?php if($_SESSION['sessUserLevel'] == 1 && strtolower($_SESSION['sessUserPermission']) == 'hr officer'): ?>
                <li>
                    <a href="<?=base_url('home/switch_hr_emp')?>">
                        <i class="icon-user"></i> Employee Module </a>
                </li>
            <?php endif; ?>
            <?php if($_SESSION['sessUserLevel'] == 5 && strtolower($_SESSION['sessUserPermission']) == 'hr officer'): ?>
                <li>

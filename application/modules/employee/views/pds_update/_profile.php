	            ...
	            <div class="form-group">
	            	...
	            	<div class="input-icon right">
	            		<input type="text" class="form-control" name="strSname" id="strSname" maxlength="50" 
	            				value="<?=isset($arrData[0]['surname']) ? (isset($pds_details) ? $pds_details[0] : $arrData[0]['surname'] ) : ''?>" autocomplete="off">
		            </div>
	            </div>
	        </div>
	    </div>
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strFname" id="strFname" maxlength="50" 
								value="<?=isset($arrData[0]['firstname'])  ? (isset($pds_details) ? $pds_details[1] : $arrData[0]['firstname']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strMname" id="strMname" maxlength="50"
							value="<?=isset($arrData[0]['middlename']) ? (isset($pds_details) ? $pds_details[2] : $arrData[0]['middlename']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="strExtension" maxlength="10" 
							value="<?=isset($arrData[0]['nameExtension']) ? (isset($pds_details) ? $pds_details[3] : $arrData[0]['nameExtension']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					<input class="form-control date-picker" name="dtmBirthdate" id="dtmBirthdate" type="text" data-date-format="yyyy-mm-dd" autocomplete="off" 
							value="<?=isset($arrData[0]['birthday']) ? (isset($pds_details) ? $pds_details[4] : $arrData[0]['birthday']) :''?>" >
				</div>
			</div>
		</div>
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="strBirthplace" maxlength="80" 
							value="<?=isset($arrData[0]['birthPlace']) ? (isset($pds_details) ? $pds_details[5] : $arrData[0]['birthPlace']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="intWeight" maxlength="5"
							value="<?=isset($arrData[0]['weight']) ? (isset($pds_details) ? $pds_details[7] : $arrData[0]['weight']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="intHeight" maxlength="5" 
							value="<?=isset($arrData[0]['height']) ? (isset($pds_details) ? $pds_details[8] : $arrData[0]['height']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="strBlood" maxlength="6" 
							value="<?=isset($arrData[0]['bloodType']) ? (isset($pds_details) ? $pds_details[9] : $arrData[0]['bloodType']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="intGSIS" maxlength="25" 
							value="<?=isset($arrData[0]['gsisNumber']) ? (isset($pds_details) ? $pds_details[10] : $arrData[0]['gsisNumber']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control"  name="strBP" maxlength="25" 
							value="<?=isset($arrData[0]['businessPartnerNumber']) ? (isset($pds_details) ? $pds_details[11] : $arrData[0]['businessPartnerNumber']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control"  name="intPagibig" maxlength="14" 
							value="<?=isset($arrData[0]['pagibigNumber']) ? (isset($pds_details) ? $pds_details[12] : $arrData[0]['pagibigNumber']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="intPhilhealth" maxlength="14" 
							value="<?=isset($arrData[0]['philHealthNumber']) ? (isset($pds_details) ? $pds_details[13] : $arrData[0]['philHealthNumber']) : ''?>"  autocomplete="off">
				</div>
			</div>
		</div>
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="intTin" maxlength="20" 
							value="<?=isset($arrData[0]['tin']) ? (isset($pds_details) ? $pds_details[14] : $arrData[0]['tin']) : ''?>"  autocomplete="off">
				</div>
			</div>
		</div>
		<hr>
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="strBlk1" id="strBlk1" maxlength="10" 
							value="<?=isset($arrData[0]['lot1']) ? (isset($pds_details) ? $pds_details[15] : $arrData[0]['lot1']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strStreet1" id="strStreet1" maxlength="50" 
								value="<?=isset($arrData[0]['street1']) ? (isset($pds_details) ? $pds_details[16] : $arrData[0]['street1']) : ''?>"  autocomplete="off">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strSubd1" id="strSubd1" maxlength="50"
								value="<?=isset($arrData[0]['subdivision1']) ? (isset($pds_details) ? $pds_details[17] : $arrData[0]['subdivision1']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strBrgy1" id="strBrgy1" maxlength="50"
								value="<?=isset($arrData[0]['barangay1']) ? (isset($pds_details) ? $pds_details[18] : $arrData[0]['barangay1']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strCity1" id="strCity1" maxlength="50" 
								value="<?=isset($arrData[0]['city1']) ? (isset($pds_details) ? $pds_details[19] : $arrData[0]['city1']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strProv1" id="strProv1" maxlength="50" 
								value="<?=isset($arrData[0]['province1']) ? (isset($pds_details) ? $pds_details[20] : $arrData[0]['province1']) : ''?>"  autocomplete="off">
					</div>
				</div>
			</div>
		</div>   
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strZipCode1" id="strZipCode1" maxlength="4"
								value="<?=isset($arrData[0]['zipCode1']) ? (isset($pds_details) ? $pds_details[21] : $arrData[0]['zipCode1']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div>  
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="strTel1" maxlength="20"
							value="<?=isset($arrData[0]['telephone1']) ? (isset($pds_details) ? $pds_details[22] : $arrData[0]['telephone1']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strBlk2" id="strBlk2" maxlength="10" 
								value="<?=isset($arrData[0]['lot2']) ? (isset($pds_details) ? $pds_details[21] : $arrData[0]['lot2']) : ''?>"  autocomplete="off">
					</div>
				</div>
			</div>
		</div> 
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strStreet2" id="strStreet2" maxlength="50" 
								value="<?=isset($arrData[0]['street2']) ? (isset($pds_details) ? $pds_details[22] : $arrData[0]['street2']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div> 
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strSubd2" id="strSubd2" maxlength="50" 
								value="<?=isset($arrData[0]['subdivision2']) ? (isset($pds_details) ? $pds_details[23] : $arrData[0]['subdivision2']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div> 
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strBrgy2" id="strBrgy2" maxlength="50"
								value="<?=isset($arrData[0]['barangay2']) ? (isset($pds_details) ? $pds_details[24] : $arrData[0]['barangay2']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div> 
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strCity2" id="strCity2" maxlength="50" 
								value="<?=isset($arrData[0]['city2']) ? (isset($pds_details) ? $pds_details[25] : $arrData[0]['city2']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div>  
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strProv2" id="strProv2" maxlength="50" 
								value="<?=isset($arrData[0]['province2']) ? (isset($pds_details) ? $pds_details[26] : $arrData[0]['province2']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div>   
				...
				<div class="form-group">
					...
					<div class="input-icon right">
						<input type="text" class="form-control" name="strZipCode2" id="strZipCode2" maxlength="4" 
								value="<?=isset($arrData[0]['zipCode2']) ? (isset($pds_details) ? $pds_details[27] : $arrData[0]['zipCode2']) : ''?>" autocomplete="off">
					</div>
				</div>
			</div>
		</div> 
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="intTel2" maxlength="20" 
							value="<?=isset($arrData[0]['telephone2']) ? (isset($pds_details) ? $pds_details[28] : $arrData[0]['telephone2']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>  
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="strEmail" maxlength="30" 
							value="<?=isset($arrData[0]['email']) ? (isset($pds_details) ? $pds_details[29] : $arrData[0]['email']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div>    
			...
			<div class="col-sm-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="strCP" maxlength="15" 
							value="<?=isset($arrData[0]['mobile']) ? (isset($pds_details) ? $pds_details[30] : $arrData[0]['mobile']) : ''?>" autocomplete="off">
				</div>
			</div>
		</div> 

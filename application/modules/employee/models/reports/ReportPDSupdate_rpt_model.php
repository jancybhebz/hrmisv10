		...
		foreach($arrDetails as $row)
			...
			$this->fpdf->Ln(5);
				...
				foreach($rsLD as $training) 
				{
					...
					$this->fpdf->FancyRow(array(($training['trainingDesc']), $startDate, $endDate, $training['trainingHours'], $training['trainingTypeofLD'], utf8_decode($training['trainingConductedBy'])),array(1,1,1,1,1,1),1);		
				}

    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form action="<?=base_url('libraries/org_structure/delete_division/'.$this->uri->segment(4))?>" method="post" id="frmOrgStructure">
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" value="<?=isset($arrDivision[0]['group2Code'])?$arrDivision[0]['group2Code']:''?>" disabled>
                                </div>
                            </div>
                        </div>
                    </div>

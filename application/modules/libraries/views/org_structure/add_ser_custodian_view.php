        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Add Custodian</span>
                </div>
                
            </div>
            <div class="portlet-body">
                <form action = "<?=base_url('libraries/org_structure/add_ser_custodian')?>" method="post" id="frmOrgStructure">
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                  <select type="text" class="form-control" name="strEmployee" value="<?=!empty($this->session->userdata('strEmployee'))?$this->session->userdata('strEmployee'):''?>" required>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="libraries_org_structure">
                    ...
                    foreach($arrService as $service):?>
                        <tr class="odd gradeX">
                            <td> <?=$i?> </td>
                            <td> <?=$service['group2Custodian']?> </td>                           
                            <td>
                                <a href="<?=base_url('libraries/org_structure/delete_ser_custodian/'.$service['group2Code'])?>"><button class="btn btn-sm btn-danger"><span class="fa fa-edit" title="Delete"></span> Delete</button></a>
                            </td>

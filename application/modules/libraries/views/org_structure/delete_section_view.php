    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form action="<?=base_url('libraries/org_structure/delete_section/'.$this->uri->segment(4))?>" method="post" id="frmOrgStructure">
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <?php foreach($arrSection as $section):?>
                                    <input  type="text" class="form-control"  value="<?php $arrCust=employee_details($section['group4Custodian']); echo count($arrCust)>0?$arrCust[0]['surname'].' '.$arrCust[0]['firstname']:''?>" disabled>      
                                    <?php endforeach;?> 
                                </div>
                            </div>
                        </div>

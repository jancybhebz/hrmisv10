    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form action = "<?=base_url('libraries/org_structure/add_sec_custodian')?>" method="post" id="frmOrgStructure">
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="libraries_org_structure">
                    ...
                    foreach($arrSection as $section):?>
                        <tr class="odd gradeX">
                            <td> <?=$i?> </td>
                            <td> <?=$section['group4Custodian']?> </td>                           
                            <td>
                                <a href="<?=base_url('libraries/org_structure/delete_sec_custodian/'.$section['group4Code'])?>"><button class="btn btn-sm btn-danger"><span class="fa fa-edit" title="Delete"></span> Delete</button></a>
                            </td>

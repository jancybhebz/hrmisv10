                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="libraries_project_code">
                    ...
                    foreach($arrProject as $row):?>
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a href="<?=base_url('libraries/project_code/edit/'.$row['projectOrder'])?>"><button class="btn btn-sm btn-success"><span class="fa fa-edit" title="Edit"></span> Edit</button></a>
                                <a href="<?=base_url('libraries/project_code/delete/'.$row['projectOrder'])?>"><button class="btn btn-sm btn-danger"><span class="fa fa-trash" title="Delete"></span> Delete</button></a>

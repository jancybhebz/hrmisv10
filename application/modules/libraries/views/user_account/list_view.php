                    ...
                    foreach($arrUser as $row):?>
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a href="<?=base_url('libraries/user_account/reset/'.$row['empNumber'])?>"><button class="btn btn-sm btn-blue"><span class="fa fa-trash" title="Reset"></span> Reset Password</button></a>

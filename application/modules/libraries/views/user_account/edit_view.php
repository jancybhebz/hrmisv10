    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form action="<?=base_url('libraries/user_account/edit/'.$this->uri->segment(4))?>" method="post" id="frmUserAccount">
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="password" class="form-control" name="strPassword" value="<?=!empty($arrUser[0]['userPassword'])?$arrUser[0]['userPassword']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>

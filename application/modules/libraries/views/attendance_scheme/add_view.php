...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <form action="<?=base_url('libraries/attendance_scheme/add')?>" method="post" name="reportform">
                <div class="row" id="fixed_time_in">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <select name="strperson" class="form-control" id="strperson" required="" onchange="checkForBlank()">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <font color='red'> <span id="1"></span></font>
                    </div>
                </div>
            </div>
    </form>

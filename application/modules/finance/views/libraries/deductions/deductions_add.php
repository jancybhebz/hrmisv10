                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <button class="btn btn-primary" type="submit" id="btn_add_deduction"><i class="fa fa-plus"></i> <?=$action?> </button>
                                                            <a href="<?=base_url('finance/libraries/deductions')?>"><button class="btn grey-cascade" type="button"><i class="icon-ban"></i> Cancel</button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

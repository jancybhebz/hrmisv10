                    ...
                    <div class="row form-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    ...
                                    <select class="form-control select2 form-required" name="selpayrollGrp" placeholder="">
                                        <option value="null">SELECT PAYROLL GROUP</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <div class="radio-list radio-required" style="padding-bottom: 13px;">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="chkis_incPayroll" value="N" <?=isset($arrData) ? $arrData['payrollSwitch'] = 'N' ? 'checked' : '' : ''?>> No </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <select class="form-control select2 form-required" name="selattScheme" placeholder="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="text" class="form-control form-required" name="txtacctNumber" value="<?=isset($arrData) ? $arrData['AccountNum'] : ''?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <div class="radio-list " style="padding-bottom: 13px;">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="chkis_selfemployed" value="N" <?=isset($arrData) ? $arrData['taxSwitch'] == 'N' ? 'checked' : '' : ''?>> No </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <div class="radio-list radio-required" style="padding-bottom: 13px;">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="chkw_govt_vehicle" value="N" <?=isset($arrData) ? $arrData['RATAVehicle'] == 'N' ? 'checked' : '' : ''?>> No </label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <select class="form-control select2 form-required" name="seltaxStatus" placeholder="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="text" class="form-control form-required" name="txtnodependents" value="<?=isset($arrData) ? $arrData['dependents'] : ''?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <div class="radio-list radio-required" style="padding-bottom: 13px;">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="chkis_health" value="N" <?=isset($arrData) ? $arrData['healthProvider'] == 'N' ? 'checked' : '' : ''?>> No </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="text" class="form-control form-required" name="txttxtRate" value="<?=isset($arrData) ? $arrData['taxRate'] : ''?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="text" class="form-control form-required" class="form-control" name="txthazardPay" value="<?=isset($arrData) ? $arrData['hpFactor'] : ''?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <select class="form-control select2" name="selrataCode" placeholder="">
                                        <option value="null">SELECT RATA CODE</option>
                ...
                <div class="row form-body">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-icon right">
                                <i class="fa fa-warning tooltips i-required"></i>
                                <select class="form-control select2 form-required" name="selappointment" placeholder="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon right">
                                <i class="fa fa-warning tooltips i-required"></i>
                                <input type="text" class="form-control form-required" name="txtactual_salary" value="<?=isset($arrData) ? $arrData['actualSalary'] : ''?>">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon right">
                                <i class="fa fa-warning tooltips i-required"></i>
                                <input type="text" class="form-control form-required" name="txtsalaryGrade" value="<?=isset($arrData) ? $arrData['salaryGradeNumber'] : ''?>">
                            </div>
                        </div>
                        <div class="form-group">

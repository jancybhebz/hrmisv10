                        ...
                        <?=form_open('', array('method' => 'post', 'id' => 'frmleavebal'))?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    ...
                                    <input type="number" class="form-control" name="vl_start" value="0.000" step="any">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="number" class="form-control" name="vl_ut_wpay" value="0.000" step="any">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="number" class="form-control" name="vl_ut_wopay" value="0.000" step="any">
                                </div>
                            </div>
                            <!-- end vacation leave -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="number" class="form-control" name="sl_start" value="0.000" step="any">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Absent Undertime With Pay <span class="required"> * </span></label>
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="number" class="form-control" name="sl_ut_wpay" value="0.000" step="any">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Absent Undertime Without Pa <span class="required"> * </span></label>
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="number" class="form-control" name="sl_ut_wopay" value="0.000" step="any">
                                </div>
                            </div>
                            <!-- end sick leave -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="number" class="form-control" name="off_bal" value="0" step="any">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="number" class="form-control" name="fl_bal" value="0" step="any">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa fa-warning tooltips i-required"></i>
                                    <input type="number" class="form-control" name="pl_bal" value="0" step="any">
                                </div>
                            </div>
                            <!-- end others leave -->

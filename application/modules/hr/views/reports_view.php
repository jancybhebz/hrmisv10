...
<script>
    $(function(){
        ...
        $('select[name="strReports"]').change(function(){
            ...
            if($rpt=='' || $rpt=='LEEA' || $rpt=='LEAGE' || $rpt=='LEDH' || $rpt=='LEDB' || $rpt=='LEG' || $rpt=='LELS' || $rpt=='LESG' || $rpt=='LESGA' || $rpt=='LEDBA' || $rpt=='LR' || $rpt=='LVP' || $rpt=='LEA' || $rpt=='LVP' || $rpt=='PP' || $rpt=='EFDS' || $rpt=='LOYR' || $rpt=='ALF')
                $('.per-block, .employee-block').hide();
            else
                $('.per-block').show();
